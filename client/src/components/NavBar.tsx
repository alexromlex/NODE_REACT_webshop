...
const NavBar = () => {
    ...
    return (
        <Navbar key={'md'} expand={'md'} bg="light" className="mb-3">
            <Container fluid className="m-0 p-0 ps-3 pe-3">
                {mainStore.headerImg && mainStore.headerImg !== '' && <img src={mainStore.headerImg} alt={mainStore.headerName} style={{ height: 40, width: 'auto', objectFit: 'contain', cursor: 'pointer' }} className="me-3" onClick={() => navigate('/')} />}
                    ...
                    <Offcanvas.Body>
                        <Nav className="justify-content-end flex-grow-1 pe-3">
                            ...
                            {!userStore.isAuth ? (
                                ...
                                <NavDropdown autoClose active title={userStore.user?.name ? userStore.user?.name : 'Hi User!'} id={`offcanvasNavbarDropdown-expand-md`}>
